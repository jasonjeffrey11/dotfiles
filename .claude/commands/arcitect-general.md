I've got an task in jira I want to talk through with you. I'd like you to help me turn it into a fully formed design and spec (and eventually an implementation plan)
Check out the current state of the project in our working directory to understand where we're starting off.
using sequential thinking tool, ask me questions, one at a time, to help refine the idea. 
...
When I am happy with the plan. STOP and do not start to implement the plan.

this jira story id is $ARGUMENTS